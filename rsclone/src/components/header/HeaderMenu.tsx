    ...
    <aside className={`header-menu ${menu ? 'manu-open' : ''}`}>
      <div className={`header-menu-container ${menu ? 'manu-open' : ''}`}>
        <div className='header-menu-top'>
          <Link to='/' className='header-menu-logo-link' onClick={close} reloadDocument>
        ...
        <HeaderMenuItem 
          ...
          >
            <Link to='/chart/upcoming' className='header-menu-item-link' reloadDocument>Upcoming releases</Link>
            <Link to="/chart/top250" className='header-menu-item-link' reloadDocument>Top 250 Movies</Link>
            <Link to="/chart/boxoffice" className='header-menu-item-link' reloadDocument>Box Office</Link>
            <Link to="/chart/popularmovies" className='header-menu-item-link' reloadDocument>Most Popular Movies</Link>
            <Link to="/chart/lowestRated" className='header-menu-item-link' reloadDocument>Lowest Rated Movies</Link> 
          </HeaderMenuItem>
          <div className='header-menu-items-wrapper'>
            ...
            >
              ...
              <Link to="/chart/top250shows" className='header-menu-item-link' reloadDocument>Top 250 TV Shows</Link>
              <Link to="/chart/popularshows" className='header-menu-item-link' reloadDocument>Most Popular TV Shows</Link>
