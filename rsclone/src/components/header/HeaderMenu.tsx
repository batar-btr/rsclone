    ...
    <aside className={`header-menu ${menu ? 'manu-open' : ''}`}>
      <div className={`header-menu-container ${menu ? 'manu-open' : ''}`}>
        <div className='header-menu-top'>
          <Link to='/' className='header-menu-logo-link' onClick={close}>
        ...
        <HeaderMenuItem 
          ...
          >
            <Link to='/chart/upcoming' className='header-menu-item-link' onClick={close}>Upcoming releases</Link>
            ...
            <Link to="/chart/popularmovies" className='header-menu-item-link' onClick={close}>Most Popular Movies</Link>
          ...
          >
            <Link to='/celebs' className='header-menu-item-link' onClick={close}>Most Popular Celebs</Link>
          </HeaderMenuItem>
        </div>
      </div>
    </aside>
