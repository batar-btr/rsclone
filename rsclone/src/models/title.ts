...
export interface IPopularActor {
  "page": number,
  "results": IPopularActorResults[],
  "total_results": number,
  "total_pages": number
}

export type IPopularActorResults = {
  "profile_path": string,
  "adult": boolean,
  gender: number,
  "id": number,
  "known_for": IPopularActorKnownFor[],
  "known_for_department": string,
  "name": string,
  "popularity": number
}

export type IPopularActorKnownFor = {
  "poster_path": string,
  "adult": boolean,
  "overview": string,
  "release_date": string,
